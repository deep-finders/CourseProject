...
EMPTY_ELEMENTS = {'area', 'base', 'br', 'embed', 'hr', 'img', 'input', 'link', 'source'} # added input, link, source
...
SENTENCE_VOID_ELEMENTS = {'button', 'caption', 'col', 'colgroup', 'pre', 'table', 'textarea', 'td', 'tfoot',
                          'th', 'thead', 'tr', 'input', 'link', 'source', 'meta'}

#OTHER_ELEMENTS = {'input', 'link', 'source', 'meta'} #,link,source as end of a sentence as well
